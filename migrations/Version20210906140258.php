 ...
 */
final class Version20210906140258 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, photo BYTEA DEFAULT NULL, active BOOLEAN NOT NULL, new BOOLEAN NOT NULL, PRIMARY KEY(id))');
