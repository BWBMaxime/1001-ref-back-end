...
class User
{
    ...
    public function hydrate($form)
    {
        ...
        if(isset($form['address'])){
            ...
            $adress->setNumber($form['address']['number']);
            $adress->setRoad($form['address']['road']);
            $adress->setCity($form['address']['city']);
            $adress->setZipcode($form['address']['zipcode']);
            $adress->setCountry($form['address']['country']);
